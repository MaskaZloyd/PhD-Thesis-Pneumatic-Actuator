# Разработка нейросетевой суррогатной модели {#sec:ch4/sec4}
...
Стандартизация устраняет влияние разницы масштабов входных и выходных
...
Метод Байесовской оптимизации позволяет минимизировать
